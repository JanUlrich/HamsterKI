...
/*lego*/import java.io.FileOutputStream;
import java.io.PrintStream;

import de.hamster.lego.model.LHamster;
...
public class RemoteRunner {
	...
	public RemoteRunner(InstructionProcessor processor, Process p) {
		remoteProcessor = new RemoteProcessor(p.getInputStream(), p
				.getOutputStream(), processor);
	}
