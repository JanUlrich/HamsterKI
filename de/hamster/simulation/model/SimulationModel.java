...
import de.hamster.lego.model.KornDaException;
import de.hamster.lego.model.MaulNichtLeerException;
import de.hamster.model.CreateInstruction;
import de.hamster.model.HamsterException;
import de.hamster.model.HamsterInitialisierungsException;
...
import de.hamster.model.KachelLeerException;
import de.hamster.model.MauerDaException;
import de.hamster.model.MaulLeerException;
import de.hamster.model.TerminalInstruction;
import de.hamster.model.TerrainCellInstruction;
import de.hamster.model.TerrainInstruction;
...
public class SimulationModel extends Observable implements InstructionProcessor {
	...
	public synchronized Object processHamsterInstruction(
		...
		// int delay =
		// de.hamster.workbench.Workbench.getWorkbench().getDebugger()
		// .getDebuggerModel().getDelay();
	...
	public synchronized Object processTerminalInstruction(
		...
		case TerminalInstruction.READ_INT:
			return new Integer(terminal.readInt(id, message));
		case TerminalInstruction.READ_STRING:
			return terminal.readString(id, message);
		}
		return null;
	}
	...
	public synchronized ArrayList getHamsterIDs() {
	...
	public synchronized ArrayList getHamsterIDs(int col, int row) {
		ArrayList ids = new ArrayList();
		for (int i = 0; i < hamster.size(); i++) {
			Hamster h = (Hamster) hamster.get(i);
			if (h.getX() != col)
