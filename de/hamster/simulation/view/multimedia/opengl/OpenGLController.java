...
public class OpenGLController {
   ...
   public void create3DView(J3DFrame mainFrame, Workbench wb, SimulationModel simModel, DebuggerModel debModel) {
	   ...
	   canvas.addGLEventListener(listener = new OpenGLEventListener(mainFrame, canvas, animator, simModel, debModel));
	   
	   this.music = new MidiFile();
	...
	public void setRunning(boolean r) {
		this.running = r;
		if (r) startAnimator(); else stopAnimator(); 
	...
	public void toggleGrid() {
		...
		boolean b = workbench.getProperty("grid", "true").equals("true") ? true : false;
	...
	public void toggleMusic() {
		...
		this.playMusic = workbench.getProperty("music", "true").equals("true") ? true : false;
		
		if (!playMusic) this.music.stop();
		else {
			if (this.animatorRunning) {
				this.music.play("data/music.mid");
			}
	...
	public void toggleSound() {
		...
		boolean b = workbench.getProperty("sound", "true").equals("true") ? true : false;
