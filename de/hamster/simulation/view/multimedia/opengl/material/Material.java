...
public class Material {
    ...
    public void use(GLDrawable gld) {
            	
        GL gl = gld.getGL();
        
        // die Farbe immer ueberschreiben 
        gl.glMaterialfv( GL.GL_FRONT, GL.GL_AMBIENT,   this.ambient.getData()  );
        gl.glMaterialfv( GL.GL_FRONT, GL.GL_DIFFUSE,   this.diffuse.getData()  );
        gl.glMaterialfv( GL.GL_FRONT, GL.GL_SPECULAR,  this.specular.getData() );        	
        ...
        if (this.mC.getCurrentMaterial() != this) {
        	...
        	else this.mC.disableTextures(gl);
     ...
     * @deprecated
     */
    public void useMaterialColorW(GL gl, Color baseColor) {
        gl.glMaterialfv( GL.GL_FRONT, GL.GL_AMBIENT_AND_DIFFUSE,   baseColor.getData()  );
    }
