...
public class MaterialController {
	...
	public void loadMaterial(int materialID, GLDrawable gld) {
	...
	public void unloadMaterial(int materialID, GLDrawable gld) {
    ...
    public void useTextureSet(int[] set, GLDrawable gld, int mainTex) {
    ...
    public void setTextureCoordinates(GL gl, int textureUnit, int mainTextureID, float s, float t) {
    	   	
    	if (this.useVeryOldGraphicMode) {
			if (textureUnit == mainTextureID) gl.glTexCoord2f(s, t);
		} else {
	    	try {
	    		gl.glMultiTexCoord2f(GL.GL_TEXTURE0 + textureUnit, s, t);
	    	} catch (Exception e) {
				if (textureUnit == mainTextureID) gl.glTexCoord2f(s, t);
	...
	public void doTextureRefresh(GLDrawable gld) {
