...
public class Mesh {
	...
	public void draw(GLDrawable gld, long time, Obj obj) {
		...
		if (this.numberOfKeyframes() > 1 && obj != null) {			
			...
			if (obj.animating && obj.animations.size() > 0) this.interpolate(gl, time, obj);
		}
        ...
        gl.glVertexPointer( 3, GL.GL_FLOAT, 0, (ByteBuffer) this.currentVertices);               
        gl.glNormalPointer( GL.GL_FLOAT, 0, (ByteBuffer) this.currentNormals);               
        gl.glTexCoordPointer( 2, GL.GL_FLOAT, 0, (ByteBuffer) this.currentTexCoords);               

		// zack
        gl.glDrawArrays(GL.GL_TRIANGLES,0,this.numVertices);
	...
	public void drawSimple(GLDrawable gld) {
...
//			gl.glNormal3fv( k.faces.get(face).faceNormal.getData() );
			...
			gl.glTexCoord3fv( k.tvertices.get(k.faces.get(face).texCoordIDA).getData() );
			gl.glNormal3fv( k.normals.get(k.faces.get(face).a).getData() );				
			gl.glVertex3fv( k.vertices.get(k.faces.get(face).a).getData() );

			gl.glTexCoord3fv( k.tvertices.get(k.faces.get(face).texCoordIDB).getData() );
			gl.glNormal3fv( k.normals.get(k.faces.get(face).b).getData() );
			gl.glVertex3fv( k.vertices.get(k.faces.get(face).b).getData() );

			gl.glTexCoord3fv( k.tvertices.get(k.faces.get(face).texCoordIDC).getData() );
			gl.glNormal3fv( k.normals.get(k.faces.get(face).c).getData() );
			gl.glVertex3fv( k.vertices.get(k.faces.get(face).c).getData() );
